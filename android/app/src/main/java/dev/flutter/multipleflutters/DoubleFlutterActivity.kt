...
class DoubleFlutterActivity : FragmentActivity(), EngineBindingsDelegate {
    private val topBindings: EngineBindings by lazy {
        EngineBindings(activity = this, delegate = this, entrypoint = "main", initialRoute = "topMain", initialArguments = hashMapOf("color" to "red") as? Object)
    }
    private val bottomBindings: EngineBindings by lazy {
        EngineBindings(activity = this, delegate = this, entrypoint = "main", initialRoute = "bottomMain", initialArguments = hashMapOf("color" to "yellow") as? Object)
    }
